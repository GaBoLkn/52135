...
export default class CalculatorVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by CalculatorParser#implicacion.
	visitImplicacion(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#disyuncion.
	visitDisyuncion(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#conjuncion.
	visitConjuncion(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#negacion.
	visitNegacion(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by CalculatorParser#primario.
	visitPrimario(ctx) {
	  return this.visitChildren(ctx);
	}
